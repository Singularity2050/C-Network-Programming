// If the IP protocol was created before the TCP protocol, than
// checksum value will be changed. (because IP header value is changed) Therefore, to get correct checksum value,
// TCP protocol should be created first.
#include <stdio.h>
#define __linux__
#ifndef __linux__
#include <winsock2.h>
