//
// Created by 박시제 on 2021/08/12.
//

#ifndef PROTOCOL_ICMPLIB_H
#define PROTOCOL_ICMPLIB_H
...
struct ether_header
{
    ...
    uint8_t ether_shost[6]; //source eth addr
